...
describe('removeElement', () => {
    const testCases = [
        { 
            ...
            description: 'should remove all 3s and return k = 2 with nums modified to [2, 2, ...]',
        },
        { 
            val: 2, 
            ...
            description: 'should remove all 2s and return k = 5 with nums modified to [0, 1, 3, 0, 4, ...]',
        },
        { 
            val: 7, 
            nums: [], 
        ...
        { 
            ...
            expected: 0,
            expectedNums: [],
            description: 'should remove all 4s and return k = 0 with empty modified array',
        },
    ];
